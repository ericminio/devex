(function () {
	...
	//
	// =========================================================================
	.controller ('MessageTemplatesListController', ['templates', function (templates) {
		var vm         = this;
	...
	//
	// =========================================================================
	.controller ('MessageTemplateViewController', ['$sce', 'template', 'Authentication', function ($sce, template, Authentication) {
		var vm                 = this;
	...
	.controller ('MessageViewController', ['$sce', '$rootScope', 'message', 'Authentication', 'MessagesService', function ($sce, $rootScope, message, Authentication, MessagesService) {
		var vm        = this;
		vm.haveresult = false;
		vm.resultmsg  = '';
		vm.trust      = $sce.trustAsHtml;
	...
	.controller ('MessageResultController', ['$sce', 'isGoodResult', 'message', function ($sce, isGoodResult, message) {
		var vm        = this;
	...
	.controller ('MessageTemplateEditController', [
		...
		'Authentication',
		'Notification',
		function ($scope, TINYMCE_OPTIONS, $state, editing, template, Authentication, Notification) {
			var qqq        = this;
