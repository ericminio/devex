(function () {
	...
	//
	// =========================================================================
	.controller ('CapabilityEditController', ['$window', '$scope', '$state', 'capability', 'Authentication', 'Notification', 'TINYMCE_OPTIONS', 'CapabilitySkillsService',
	function ($window, $scope, $state, capability, Authentication, Notification, TINYMCE_OPTIONS, CapabilitySkillsService) {
		var qqq            = this;
