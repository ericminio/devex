	...
	.directive ('opportunityList', function () {
		return {
			...
			controller   : [
				...
				'ask',
				'UsersService',
				function ($scope, OpportunitiesService, OpportunitiesCommon, Authentication, Notification, ask, UsersService) {
					...
					if (vm.context === 'project') {
						...
						vm.userCanAdd    = (vm.isAdmin || vm.isGov);
						vm.opportunities = OpportunitiesService.query ().$promise.then (function (opps) {vm.opportunities = opps; vm.isLoading = false;});
						vm.columnCount   = 1;
					}
