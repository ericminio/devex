(function () {
	...
	//
	// -------------------------------------------------------------------------
	.controller('SettingsController', ['Authentication', function (Authentication) {
		var vm = this;
	...
	//
	// -------------------------------------------------------------------------
	.controller('ProfilePrivacyController', ['$scope', 'Authentication', 'UsersService', 'Notification', function ($scope, Authentication, UsersService, Notification) {
		var vm = this;
	...
	.controller('ProfileSkillsController', [
		...
		'CapabilitiesMethods',
		'TINYMCE_OPTIONS',
		function ($scope, $sce, Notification, Authentication, UsersService, capabilities, CapabilitiesMethods, TINYMCE_OPTIONS) {
			var vm                     = this;
	...
	//
	// -------------------------------------------------------------------------
	.controller('ProfileMessagesController', ['Authentication', function (Authentication) {
		var vm = this;
		vm.user = Authentication.user;
	}])
	;
